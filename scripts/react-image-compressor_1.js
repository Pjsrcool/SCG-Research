...
(async () => {
    ...
    }
    {
        ...
        // await element.click({ offset: { x: 79.375, y: 29.90625} });  // dont need to click
        await element.uploadFile('images/cute-baby-cats-wallpaper.jpg');  // because we automate the image upload
    }
    {
        const targetPage = page;
        ...
        //   await element.type("C:\\fakepath\\cute-baby-cats-wallpaper.jpg");
        // } else {
        //   await element.focus();
        ...
        //   }, "C:\\fakepath\\cute-baby-cats-wallpaper.jpg");
        // }
    }
    {
        const targetPage = page;
